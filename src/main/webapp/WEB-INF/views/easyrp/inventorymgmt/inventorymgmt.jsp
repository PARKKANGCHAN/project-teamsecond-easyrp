         ...
         <div class="page-heading">
                  ...
                  <div class="col-12 col-md-6 order-md-2 order-first">
                     <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item active" aria-current="page">자재 관리</li>
                        </ol>
                     </nav>
                  </div>
               </div>
            ...
            <section class="section">
               <div class="row" id="table-hover-row">
                                          ...
                                          <table class="table table-bordered" id="searchTable">
                                             ...
                                             <tr class="text-center">
                                                ...
                                                <td>
                                                   <input
                                                      type="text"
                                                      id="searchEmployeeCod"
                                                      name="searchEmployeeCod"
                                                      class="form-control"
                                             ...
                                             <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                   <li>
                                                      <a
                                                         class="dropdown-item"
                                                         href="inventorymgmtupdate?cod=${inventoryMgmt.cod}"
                                                         >수정</a
                                                      >
                                                   </li>
                                                   <li>
                                                      <a
                                                         class="dropdown-item"
                                                         href="inventorymgmtdeletefn?cod=${inventoryMgmt.cod}"
                                                         >삭제</a
                                                      >
                                                   </li>
                                                </ul>
                        ...
                        <li class="page-item <c:if test='${startPage == 1}'>disabled</c:if>">
                           <a
                              ...
                              href="<c:if test='${startPage > 1}'>?page=${startPage - 10}&searchCod=${searchVO.searchCod }&searchName=${searchVO.searchName}&searchWarehouseName=${searchVO.searchWarehouseName}
								&searchProductGroupName=${searchVO.searchProductGroupName }&searchEmployeeCod=${searchVO.searchEmployeeCod }</c:if>"
                              >이전 10 페이지</a
                           >
                        </li>
                        ...
                        <c:forEach begin="${startPage}" end="${endPage}" var="i">
                           <li class="page-item <c:if test='${i == currentPage}'>active</c:if>">
                              <a
								...
								&searchProductGroupName=${searchVO.searchProductGroupName }&searchEmployeeCod=${searchVO.searchEmployeeCod }"
                                 >${i}</a
                              >
                           </li>
                        </c:forEach>
                  ...
                  <!-- 페이지네이션 END -->
                  <div class="d-flex" style="padding-bottom: 0.5rem; padding-top: 0.5rem">
                     <div class="col-md-6">

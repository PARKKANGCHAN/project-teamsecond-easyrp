                  ...
                  <div class="col-12 col-md-6 order-md-2 order-first">
                     <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item active" aria-current="page">제품 수정</li>
                        </ol>
                     </nav>
                  </div>
               </div>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <input
                                             ...
                                             value="${getProdMgmtData.prodname}"
                                             maxlength="100"
                                             required
                                          />
                                       </td>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <input
                                             ...
                                             value="${getProdMgmtData.basicInvQty}"
                                             required
                                          />
                                       </td>
                                    </tr>
                                    <tr>
                                       ...
                                       <td>
                                          <input
                                             ...
                                             value="${getProdMgmtData.basicInvPrice}"
                                             readonly
                                             required
                                          />
                                       </td>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <input
                                             ...
                                             name="spec"
                                             class="form-control"
                                             placeholder="필요 시 사양 및 규격을 입력해주세요."
                                             value="${getProdMgmtData.spec}"
                                             maxlength="100"
                                          />
                                       </td>
                                    </tr>
                                    <tr>
                                       ...
                                       <td>
                                          <input
                                             ...
                                             value="${getProdMgmtData.safteyInvQty}"
                                             required
                                          />
                                       </td>
                                    </tr>
                                    <tr>
                                       ...
                                       <td>
                                          <input
                                             ...
                                             value="${getProdMgmtData.prodGroupName}"
                                             disabled
                                             required
                                          />
                                          <input
                                       ...
                                       <td>
                                          <input
                                             ...
                                             placeholder="우측 재고 단위 조회 버튼을 통해 재고 단위를 선택해주세요."
                                              value="${getProdMgmtData.unitName}"
                                             disabled
                                             required
                                          />
                                          <input type="hidden" id="unitCod" name="unitCod" value="${getProdMgmtData.unitCod}" />
                                          <button
                                             type="button"
                                             class="btn btn-primary"
                                             id="setValueUnitModalBtn"
                                             data-bs-toggle="modal"
                                             data-bs-target="#loadModal"
                                             style="margin-left: 2rem; width: 15%"
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <input
                                             ...
                                             value="${getProdMgmtData.mgmtUnitName}" 
                                             disabled
                                             required
                                          />
                                          <input type="hidden" id="mgmtUnitCod" name="mgmtUnitCod" value="${getProdMgmtData.mgmtUnitCod}" />
                                          <button
                                             type="button"
                                             class="btn btn-primary"
                                             id="setValueMgmtUnitModalBtn"
                                             data-bs-toggle="modal"
                                             data-bs-target="#loadModal"
                                             style="margin-left: 2rem; width: 15%"
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <input
                                             ...
                                             value="${getProdMgmtData.warehouseName}"
                                             disabled
                                             required
                                          />
                                          <input type="hidden" id="warehouseCod" name="warehouseCod" value="${getProdMgmtData.warehouseCod}" />
                                          <button
                                             type="button"
                                             class="btn btn-primary"
                                             id="warehouseModalBtn"
                                             data-bs-toggle="modal"
                                             data-bs-target="#loadModal"
                                             style="margin-left: 2rem; width: 15%"

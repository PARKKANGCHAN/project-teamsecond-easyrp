			...
			<div class="page-title">
				<div class="row">
					<div class="col-12 col-md-6 order-md-1 order-last">
						<h3>제품 수정</h3>
						<p class="text-subtitle text-muted">제품의 기초 수정 및 BOM 수정을 위한 페이지</p>
					</div>
						...
						<div class="card mb-4">
							<div class="card-header py-3">
								<div class="d-flex" style="justify-content: space-between">
									<h5 class="m-0">제품 수정</h5>
								</div>
							</div>
							<div class="card-body mb-3">
								<form action="productmgmtupdatefn" method="post">
									<div class="mb-4">
										<table class="table table-bordered">
											<tr>
												<td width="150">제품 번호</td>
												<td><input type="text" id="cod" name="cod"
													class="form-control" value="${getProdMgmtData.cod}"
											...
											<tr>
												...
												<td><input type="text" id="prodname" name="prodname"
													...
													value="${getProdMgmtData.prodname}" maxlength="100"
													required /></td>
											</tr>
											<tr>
												...
												<td><input type="number" id="unitprice"
													...
													value="${getProdMgmtData.unitprice}" required /></td>
											</tr>
											<tr>
												<td width="150">기초재고 수량</td>
												<td><input type="number" id="basicInvQty"
													name="basicInvQty" class="form-control"
													placeholder="현재 입고된 기준의 재고수량을 입력해주세요."
													value="${getProdMgmtData.basicInvQty}" required /></td>
											</tr>
											<tr>
												<td width="150">기초재고 금액</td>
												<td><input type="number" id="basicInvPrice"
													name="basicInvPrice" class="form-control"
													placeholder="단가 * 기초재고 수량으로 계산해 자동 입력됩니다."
													value="${getProdMgmtData.basicInvPrice}" readonly required />
												</td>
											</tr>
											<tr>
												...
												<td><input type="text" id="spec" name="spec"
													...
													value="${getProdMgmtData.spec}" maxlength="100" /></td>
											</tr>
											<tr>
												<td width="150">안전재고 수량</td>
												<td><input type="number" id="safteyInvQty"
													name="safteyInvQty" class="form-control"
													placeholder="품절을 막기위한 최소한의 수량 커트라인을 기입해주세요."
													value="${getProdMgmtData.safteyInvQty}" required /></td>
											</tr>
											<tr>
												<td width="150">제품 그룹</td>
												<td><input type="text" id="productGroupName"
													class="form-control" style="width: 70%; float: left"
													placeholder="우측 제품 그룹 조회 버튼을 통해 제품 그룹을 선택해주세요."
													value="${getProdMgmtData.prodGroupName}" disabled required />
													<input type="hidden" id="productGroupCod"
													name="productGroupCod"
													value="${getProdMgmtData.productGroupCod}" />
											...
											<tr>
												...
												<td><input type="text" id="unitName"
													...
													value="${getProdMgmtData.unitName}" disabled required /> <input
													type="hidden" id="unitCod" name="unitCod"
													value="${getProdMgmtData.unitCod}" />
													<button type="button" class="btn btn-primary"
											...
											<tr>
												...
												<td><input type="number" id="unitAmount"
													...
													value="${getProdMgmtData.unitAmount}"
											...
											<tr>
												...
												<td><input type="text" id="mgmtUnitName"
													class="form-control" style="width: 70%; float: left"
													placeholder="우측 관리 단위 조회 버튼을 통해 관리 단위를 선택해주세요."
													value="${getProdMgmtData.mgmtUnitName}" disabled required />
													<input type="hidden" id="mgmtUnitCod" name="mgmtUnitCod"
													value="${getProdMgmtData.mgmtUnitCod}" />
													<button type="button" class="btn btn-primary"
											...
											<tr>
												...
												<td><input type="number" id="mgmtUnitAmount"
													...
													value="${getProdMgmtData.mgmtUnitAmount}"
											...
											<tr>
												...
												<td><input type="text" id="warehouseName"
													class="form-control" style="width: 70%; float: left"
													placeholder="우측 창고 조회 버튼을 통해 재고가 있는 창고를 선택해주세요."
													value="${getProdMgmtData.warehouseName}" disabled required />
													<input type="hidden" id="warehouseCod" name="warehouseCod"
													value="${getProdMgmtData.warehouseCod}" />
													<button type="button" class="btn btn-primary"
											...
											<tr>
												...
												<td><input type="text" id="empName"
													...
													value="${empName }" disabled /> <input type="hidden"
													id="employeeCod" name="employeeCod" value="${empCode }" />
												</td>
											</tr>
											<tr>
												<td width="150">메 모</td>
									...
									<input type="hidden" id="curInvQty" name="curInvQty"
										value="${getProdMgmtData.curInvQty}" readonly required /> <input
										type="hidden" id="curInvPrice" name="curInvPrice"
										value="${getProdMgmtData.curInvPrice}" readonly required />
								</form>
							</div>
						</div>
					</div>

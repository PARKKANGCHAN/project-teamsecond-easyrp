			...
			<div class="page-title">
				<div class="row">
					<div class="col-12 col-md-6 order-md-1 order-last">
						<h3>거래처 수정</h3>
						<p class="text-subtitle text-muted">거래처의 기초 수정을 위한 페이지</p>
					</div>
						...
						<div class="card mb-4">
							<div class="card-header py-3">
								<div class="d-flex" style="justify-content: space-between">
									<h5 class="m-0">거래처 수정</h5>
								</div>
							</div>
							<div class="card-body mb-3">
								<form action="clientupdatefn" method="post">
									<div class="mb-4">
										<table class="table table-bordered">
											<tr>
												<td width="150">거래처 번호</td>
												<td><input type="text" id="cod" name="cod"
													class="form-control" value="${getClientData.cod}"
											...
											<tr>
												...
												<td><input type="text" id="representative"
													...
													value="${getClientData.representative}"
											...
											<tr>
												...
												<td><input type="text" id="managerName"
													...
													value="${getClientData.managerName}"
											...
											<tr>
												...
												<td><input type="text" id="managerTel"
													...
													value="${getClientData.managerTel}"
													placeholder="거래처측 매니저 전화번호를 입력해주세요." required /></td>
											</tr>
											<tr>
												<td width="150">Fax</td>
												<td><input type="text" id="faxnum" name="faxnum"
													value="${getClientData.faxnum}" class="form-control"
													placeholder="Fax번호를 입력해주세요. (- 입력 필수)" required /></td>
											</tr>
											<tr>
												<td width="150">거래처 주소</td>
												<td><input type="text" id="address" name="address"
													value="${getClientData.address}" class="form-control"
													placeholder="거래처 주소를 입력해주세요." required /></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><input type="text" id="discountClass"
													...
													value="${getClientData.discountClass}"
													style="width: 70%; float: left"
													placeholder="거래처 등급 수정 버튼을 눌러 수정해주세요." readonly required />
